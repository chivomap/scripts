"""
Convertir Shapefiles a GeoJSON (nota: funcionó mejor que convertir a TopoJSON)
"""
import os
import geopandas as gpd
import time

# Definir el directorio de salida para los archivos GeoJSON (ruta relativa)
output_dir = "data/geo/geojson"
...
def convert_shapefile_to_geojson(shapefile_path, output_dir):
    try:
        ...
        print(f"Error al convertir '{shapefile_path}': {e}")
...
def find_and_convert_shapefiles(start_dir):
    ...
    if shapefile_count == 0:
        ...
        print(f"Proceso completo para {shapefile_count} archivos en {total_end_time - total_start_time:.2f} segundos")

if __name__ == "__main__":
    # Directorio de búsqueda (data-vmt) (ruta corregida)
    data_vmt_dir = "data/raw"
